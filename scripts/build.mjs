...
function aboutPage(locale) {
  ...
  const description = tr ? "MassLabs’ın çalışma yaklaşımını, değerlerini ve İzmir merkezli dinamik ekibini tanıyın." : "Learn about MassLabs, our working principles and our dynamic team based in Izmir.";
  const body = pageHero(locale, tr ? "Hakkımızda" : "About", title, tr ? "MassLabs, işletmelerin ve ürün ekiplerinin modern yazılım teknolojilerinden etkili biçimde yararlanmasına yardımcı olmak için kuruldu." : "MassLabs was founded to help businesses and product teams make effective use of modern software technology.") +
    '<section class="section section--first"><div class="shell narrative-grid"><div><span class="eyebrow-label">' + (tr ? "Nasıl çalışıyoruz?" : "How we work") + "</span><h2>" + (tr ? "Dinamik yapı, projeye göre genişleyen uzmanlık." : "A dynamic structure, extended with the right expertise for each project.") + "</h2></div><div><p>" + (tr ? "Yapay zekâ, otomasyon, SaaS ve özel yazılım alanlarında araştırma yapıyor; uygulanabilir çözümler tasarlayıp geliştiriyoruz. Dinamik ekip yapımız iletişimi doğrudan tutarken, ihtiyaç olduğunda projeye özel uzmanlarla çalışma modelimizi genişletiyoruz." : "We research AI, automation, SaaS and custom software, then design and build practical solutions. Our dynamic structure keeps communication direct, while project-specific specialists extend the team when needed.") + "</p><p>" + (tr ? "Amacımız tek seferlik teslimlerin ötesinde, sistemi anlayan ve ürünün gelişimine uzun vadede katkı veren teknik bir iş ortağı olmak." : "Our goal is to go beyond one-off delivery and become a technical partner who understands the system and contributes to the product over time.") + "</p></div></div></section>" +
    ...
    '<section class="section"><div class="shell founder-section"><div><span class="eyebrow-label">' + (tr ? "Kurucu ekip" : "Founding team") + "</span><h2>" + (tr ? "Kurucu ekip, doğrudan iletişim." : "Founding team, direct communication.") + "</h2><p>" + (tr ? "MassLabs İzmir’de kuruldu. Projelerin araştırma, ürün ve geliştirme süreçleri kurucu ekip tarafından doğrudan takip edilir." : "MassLabs was founded in Izmir. The founding team remains directly involved in research, product and development work.") + '</p></div><div class="founder-list">' + (founderCards || '<div class="founder-placeholder"><span>ML</span><p>' + (tr ? "Ürün ve yazılım geliştirme odağında çalışan kurucu ekip." : "A founding team focused on product and software development.") + "</p></div>") + "</div></div></section>" + ctaBlock(locale, true);
